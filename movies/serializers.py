...
class ShowtimeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Showtime
        fields = ['id', 'movie', 'movie_title', 'show_date', 'show_time', 
...
class MovieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Movie
        fields = ['id', 'title', 'description', 'genres', 'genre_ids', 
...
class MovieListSerializer(serializers.ModelSerializer):
    """Lightweight serializer for movie list"""
    genres = GenreSerializer(many=True, read_only=True)
    
    class Meta:
        model = Movie
        fields = ['id', 'title', 'description', 'genres', 'duration', 
                  'rating', 'release_date', 'poster', 'language', 'is_active']
