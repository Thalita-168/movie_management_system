...
├── ROLES_DOCUMENTATION.md     # Role system docs
...
│   ├── models.py             # Movie, Genre, Showtime models
│   ├── views.py              # Movie CRUD views
│   ├── forms.py              # Movie and showtime forms
...
│
├── templates/                 # HTML templates (standalone)
│   ├── base.html             # Base template (reference only)
│   ├── accounts/
│   │   ├── login.html        # Login page
│   │   ├── register.html     # Registration page
│   │   └── profile.html      # User profile
│   ├── movies/
│   │   ├── movie_list.html   # Browse movies
│   │   ├── movie_detail.html # Movie details
│   │   ├── movie_form.html   # Add/edit movie
